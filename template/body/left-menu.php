...
<div><hr /></div>
<div><a id="login_menu" href="#" onclick="getURL('GET','#page','pages/form-login.php',{})">Login</a></div>
<div><a id="register_menu" href="#" onclick="getURL('GET','#page','pages/form-register.php',{})">Register</a></div>